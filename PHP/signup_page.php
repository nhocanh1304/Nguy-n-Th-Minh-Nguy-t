  ...
  <div class="p-8 max-w-md w-full bg-white rounded shadow">
    ...
    <form action="signup_page.php" method="post">
      ...
      <div class="flex flex-col md:flex-row md:justify-between">
        <button type="submit" name="button_login" class="w-full md:w-auto mt-4 md:mt-0 bg-red-500 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline hover:bg-red-600">Log In</button>

        <button type="submit" name="button_regist" class="w-full md:w-auto bg-indigo-500 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline hover:bg-indigo-600">Sign Up</button>
      </div>
    </form>
  </div>
</body>
